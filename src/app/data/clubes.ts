 ...
 * se tuvo que cambiar el nombre ya que este pertenecia a clubes y no generos
 * al momento de mandar a llamar el modelo
 */
export const clubes = [{
                            id : 6,
                            nombre : 'Cruz Azul',
